# Key4hep Reconstruction Validation (k4-reco-val)

An automated validation framework for evaluating detector simulation and reconstruction performance (ALLEGRO and IDEA) within the Key4hep ecosystem. The pipeline processes digitized ROOT event samples, generates standardized validation histograms and performance plots, and publishes a static HTML web report dashboard.
...
```text
.
├── config/                 # Detector configurations (ALLEGRO, IDEA), plotting, and web layout configs
